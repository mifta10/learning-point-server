...
// mongodb connection 
mongoose.connect(
  `mongodb+srv://${ process.env.MONGO_DB_USER }${ process.env.MONGO_DB_PASSWORD }@cluster0.8pac6.mongodb.net/${ process.env.MONGO_DB_DATABASE }?retryWrites=true&w=majority`
).then(() => {
